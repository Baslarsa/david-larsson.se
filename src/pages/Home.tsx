      ...
      >
        ...
        >
          <div className="w-full h-full flex">
            <div className="absolute hidden md:block bottom-5 left-5 md:w-2/3 w-screen z-10 py-3 dark:text-white text-black bg-white md:bg-transparent dark:bg-black">
